<?php
// This Script Will Handle Donor Login 
...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if (empty($username_err) && empty($password_err)) {
        $sql = "SELECT id, username, password, gender, usertype FROM seekers WHERE username = ?";
    ...
    // Try to execute this statement
        if (mysqli_stmt_execute($stmt)) {
            ...
            if (mysqli_stmt_num_rows($stmt) == 1) {
                mysqli_stmt_bind_result($stmt, $id, $username, $hased_password, $param_gender, $param_usertype);
                if(mysqli_stmt_fetch($stmt)){
                    if(password_verify($password, $hased_password)){
                        ...
                        $_SESSION["age"] = $param_age;
                        $_SESSION["gender"] = $param_gender;
                        $_SESSION["usertype"] = $param_usertype;
                        $_SESSION["userRole"] = "Seeker";
                        $_SESSION["loggedin"] = true;

                        // Redirect user to Dashboard
                        header("location: Dashboard_Seeker.php");
                    }
                }
            }
        }
...
<nav class="navbar">
    ...
    <section id="container">
        <div class="login-box">
            <center><h3 >Seeker Login Page</h3></center>
            <hr>
            ...
            <form action="" method="post">
                ...
                <br>
                <button type="submit" class="btn-login ">Login <svg fill="#ffffff" height="20px" width="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M352 96l64 0c17.7 0 32 14.3 32 32l0 256c0 17.7-14.3 32-32 32l-64 0c-17.7 0-32 14.3-32 32s14.3 32 32 32l64 0c53 0 96-43 96-96l0-256c0-53-43-96-96-96l-64 0c-17.7 0-32 14.3-32 32s14.3 32 32 32zm-9.4 182.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L242.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l210.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z"/></svg></button>
                <br>
                <span>Don't have an account? </span>
                <span  > <a id="signup"  href="Seeker_register.php">Sign up</a></span>
            </div>
            </form>
        </div>
    </section>
